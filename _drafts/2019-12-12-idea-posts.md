...
2. Start rendering
3. Resolve tweets to render

The approach is quite different in the code and you might feel it's easier to reason about. The removal of state management and life cycle events reduce the complexity. The user gets a more responsive UI because we are starting to resolve data first while rendering.
